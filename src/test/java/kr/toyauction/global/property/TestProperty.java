...
public class TestProperty {
	...
	public static final String PNG_CLASSPATH = "classpath:static/gumi.png";
	public static final String PNG_FILENAME = "gumi.png";

	public static final String TXT_CLASSPATH = "classpath:static/memo.txt";
